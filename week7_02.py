class PostOffice:
    ...
    def send_message(self, sender, recipient, message_body, urgent=False):
        ...
        message_details = {
            ...
            'body': message_body,
            'sender': sender,
            # Add bool to mark if read or not
            'read': False
        }
        if urgent:
...
if __name__ == '__main__':
    ...
    print(post_office.boxes['aaa'])
    print(post_office.boxes['bbb'])
    print(post_office.boxes['ccc'])
    print(post_office.read_inbox('aaa', 1))
    print(post_office.read_inbox('bbb', 1))
    print(post_office.read_inbox('bbb', 2))
    print(post_office.search_inbox('bbb', "2"))